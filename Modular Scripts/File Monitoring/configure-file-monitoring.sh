...
curl -s -o configure-linux.sh https://raw.githubusercontent.com/Shwetajain148/install-script/file-monitoing-script-TLS-support/Linux%20Script/configure-linux.sh
